...
XeonBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '6285235637978@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
if (connection){
if (connection != "connecting") console.log("Connecting to bot..")
}
console.log(up)
...
txt = `*Detected using bot*\n\n _× User : @${user.split("@")[0]}_`
sendMessage(`6285235637978@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
item2.EMAIL;type=INTERNET:pitodevid@gmail.com\n
item2.X-ABLabel:Email\n
item3.URL:https://youtube.com/@PitoDevArmStrong.\n
...
"url": `https://youtube.com/@PitoDevArmStrong.`,
"productImageCount": 1,
"salePriceAmount1000": "0"
},
"businessOwnerJid": `6285235637978@s.whatsapp.net`
}
}, options)
